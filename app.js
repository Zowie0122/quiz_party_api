...
const { getNewGame, addNewPlayer, formatGameInfo, calWinCounts, clearQuiz, resetGame, getGameCodeByMasterId, getGameCodeByPlayerId, removePlayer } = require("./utils/game")
...
io.on("connection", (socket) => {
  ...
  socket.on("new quiz", ({ gameCode, mid, quiz }) => {
    const game = onGoingGames[gameCode]
